...
public class Conexion {
    ...
    private final String usuario = "Windows";  // Windows
    private final String contrasenia = "root"; //root
    private final String url = "jdbc:mysql://192.168.1.3:"; // localhost, 192.168.1.3
